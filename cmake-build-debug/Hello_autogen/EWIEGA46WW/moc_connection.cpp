...
QT_MOC_LITERAL(3, 21, 23) // "on_pushButton_3_clicked"

    },
    "connection\0showmain\0\0on_pushButton_3_clicked"
};
...
void connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&connection::showmain)) {
                *result = 0;
                return;
            }
        }
